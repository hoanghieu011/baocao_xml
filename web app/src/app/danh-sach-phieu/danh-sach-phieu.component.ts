...
import { NghiPhepService, NghiPhepSearchDto } from '../services/nghi-phep.service'
...
@Component({
  ...
  styleUrl: './danh-sach-phieu.component.css'
})
export class DanhSachPhieuComponent implements OnInit {
  ...
  ds_trang_thai: any[] = [];
  updateStatusList() {
    const selectedValue = this.currentStatus;
  ...
  ngOnInit(): void {
    ...
    this.searchForm.patchValue({ status: 'Tất cả' });
  ...
  searchPhieuNghi() {
    ...
    this.nghiPhepService.searchNghiPhepCn(searchDto).subscribe({
      next: response => {
  ...
  viewPhieuNghiDetails(phieu_nghi_id: number) {
    ...
    this.inforForm.patchValue({
      ...
      : (this.phieu_nghi_selected.duyet === 0
        ...
        : (this.phieu_nghi_selected.trangThai === "3"
          ...
          // : (this.phieu_nghi_selected.trangThai !== "-1" && 
          //    this.phieu_nghi_selected.trangThai !== "3" && 
          //    this.phieu_nghi_selected.duyet === 1 && 
          // (this.phieu_nghi_selected.nvXuLy1 !== null || 
          //    this.phieu_nghi_selected.nvXuLy2 !== null || 
          //    this.phieu_nghi_selected.nvXuLy3 !== null)
    ...
    this.nghiPhepService.updateThongBao(phieu_nghi_id);
  }
