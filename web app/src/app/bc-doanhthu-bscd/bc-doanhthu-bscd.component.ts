...
@Component({
  ...
  templateUrl: './bc-doanhthu-bscd.component.html',
  styleUrl: './bc-doanhthu-bscd.component.css'
})


export class BcDoanhthuBscdComponent implements OnInit {
  ...
  exportExcel() {
    ...
    this.baoCaoService.exportBcDoanhThuBscdExcel(
      ...
      next: (blob) => {
        const fileName = `bao_cao_doanhthu_bscd_${this.tuNgay}_${this.denNgay}.xlsx`;
