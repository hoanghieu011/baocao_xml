...
export class DiemKeHoachComponent  {
  ...
  onSaveDiemKeHoach() {
    ...
    if(this.selectedDiemKeHoach?.diemKeHoachId > 0) {
      diemKeHoach = {
        ...
        soBnNhapVienNgoaiGio: this.formDataDiemKeHoach.get('soBnNhapVienNgoaiGio')?.value || 0,
  ...
  onSuaDiemKeHoachBtnClick(diemKeHoach: any) {
    ...
    this.formDataDiemKeHoach =  new FormGroup({
      ...
      soBnNhapVienNgoaiGio: new FormControl(this.selectedDiemKeHoach.soBnNhapVienNgoaiGio, [Validators.required]),
